...
# Migration-Script (currently in testing) from WRF version 4.4.0 to 4.5.0
...
# compatibility for WRF model due to libxml2 update from may 2025
yay -S --noconfirm --needed libxml2-legacy

# old folder names and new one; adjust to WRF 4.2.0 if required
FILE_NAME_OLD='wrf_450'; WRF_FOLDER_OLD='WRF-4.5'; WPS_FOLDER_OLD='WPS-4.5'
FILE_NAME='wrf_460'; WRF_FOLDER='WRF-4.6.1'; WPS_FOLDER='WPS-4.6.0'
